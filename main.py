...
if os.name == "nt":
    ctypes.windll.kernel32.SetConsoleTitleW(f"Ves's Boosts Tool")
else:
    pass
...
"""))
    ...
    if choice == "1":
        invite = getinviteCode(input(f"{Fore.WHITE}> {Fore.LIGHTBLACK_EX}Invite Link/Code (Example: discord.gg/vesservice):{Fore.RESET} "))
